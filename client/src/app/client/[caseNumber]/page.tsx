...
export default function AdminCasePage({
  ...
  function findNextUnansweredQuestion(
    ...
    for (let i = currentPage + 1; i < interrogatories.length; i++) {
      if (!interrogatories[i]?.plaintiffClientResponse?.trim()) return i;
    }
  ...
  const unansweredCount = interrogatories.filter(
    (q) => !q.plaintiffClientResponse?.trim(),
  ).length;
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto bg-white md:bg-white/95 md:backdrop-blur-sm rounded-none md:rounded-xl shadow-none md:shadow-xl p-4 md:p-8">
          ...
          <div className="mt-2 border border-gray-300 p-5 rounded-md">
            ...
            <div className="mt-5">
              ...
              <textarea
                ...
                className="w-full min-h-[120px] border border-gray-300 rounded-md p-3"
              />
            </div>
          </div>
        )}
        ...
        <div className="mt-5 mb-5">
          <div className="text-center font-medium mb-4">
            INTERROGATORY NO. {currentPage + 1} /{" "}
          ...
          <div className="flex justify-between items-center gap-4">
            ...
            <button
              ...
              onClick={() => {
                ...
                if (currentPage < interrogatories.length - 1) {
            ...
            >
              {isAtLastQuestion && unansweredCount === 0
                ? "Completed"
                : isAtLastQuestion
                  ? "Next Unanswered"
                  : "Next"}
