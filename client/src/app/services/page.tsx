...
const SERVICES_PAGE_QUERY = groq`*[_type == "slider" && slug.current == "services"][0]{title, "slug": slug.current, slides[]{paragraph, label, backgroundColor, "image": image.asset->url}}`
