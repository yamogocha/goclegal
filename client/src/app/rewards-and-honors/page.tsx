...
const AWARDS_AND_HONORS_PAGE_QUERY = groq`*[_type == "slider" && slug.current == "awards-and-honors"][0]{title, description, "slug": slug.current, slides[]{"slug": reference->slug.current, paragraph, label, backgroundColor, "image": image.asset->url}}`
