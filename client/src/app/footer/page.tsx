...
{firmInformationTitle, firmInformation[]{label, detail}, resourcesTitle, resourcesLinks[]{label, "slug": reference->slug.current, manual}, servicesTitle, servicesLinks[]{label, "slug": reference->slug.current}, copyright}`
