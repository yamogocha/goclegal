        ...
        <div id={slug} className="scroll-mt-20 lg:scroll-mt-5 w-full h-full bg-[#323232] px-5 py-10 lg:py-[120px]">
            <MotionWrapper className="max-w-[1200px] m-auto flex flex-col lg:flex-row lg:items-center">
                ...
                <div className="relative flex flex-wrap gap-10 justify-end">
                        ...
                        return (
                            <div key={index} className="w-full lg:w-[45%] h-[400px]">
                                ...
                                <div className={`w-full h-full rounded p-10 flex flex-col justify-between 
                                    ...
                                    <Link href={`/${slug}`} className={`w-fit font-montserrat font-medium rounded text-[16px] lg:text-[18px] p-2 border transition duration-300 ease-out
                    ...
                    <span 
                        className="absolute right-0 top-[200px] lg:top-1/2 -translate-y-1/2 rounded-tl rounded-bl bg-linear-to-r from-[#00305b] to-[#004c8f] gradient-animate px-2 py-5 lg:px-5 lg:py-10 cursor-pointer shadow-[0_0px_10px_rgba(0,0,0,0.3)]"
