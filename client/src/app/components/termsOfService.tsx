...
export default function TermsOfServiceComponent(TermsOfServicePage: TermsOfServicePage) {
    const {headline, image, body} = TermsOfServicePage
    return(
        <div className="bg-[#00305bcf] w-full h-full">
            <div className="relative w-full h-[200px] lg:h-[400px]">
                ...
                <MotionWrapper className="w-full lg:w-2/3 m-auto h-[200px] lg:h-[400px] px-5 flex flex-col justify-center item-center text-center text-white">
