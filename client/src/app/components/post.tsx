...
export default function PostComponent(postQuery: Post) {
    const { headline, subHeadline, image, imageUpdatedAt, columnLeft, columnRight, buttonText, phoneNumber } = postQuery

    return(
        <div className="bg-[#00305bcf] w-full h-full">
            <div className="relative w-full h-[300px] lg:h-[400px]">
                <Image src={`${image}?t=${imageUpdatedAt}`} alt="Auto Accidents background image" fill className='object-cover -z-5'/>
